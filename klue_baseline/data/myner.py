...
class KlueNERProcessor(DataProcessor):
    ...
    origin_train_file_name = "C:/Users/user/Documents/cuknlp/intoCNS/KoNLU_v5.0/final_code.json"
    origin_test_file_name = "C:/Users/user/Documents/cuknlp/intoCNS/KoNLU_v5.0/final_code.json"
    origin_dev_file_name = "C:/Users/user/Documents/cuknlp/intoCNS/KoNLU_v5.0/final_code.json"
    ...
    def __init__(self, args: argparse.Namespace, tokenizer: PreTrainedTokenizer) -> None:
        ...
        self.label2idx = {label: i for i, label in enumerate(["B-symptom", "I-symptom", "B-animal", "I-animal", "B-name", "I-name", "O"])}
    ...
    def get_labels(self) -> List[str]:
        return ["B-symptom", "I-symptom", "E-symptom", "B-animal", "I-animal", "E-animal", "B-name", "I-name",
                  "E-name"]
